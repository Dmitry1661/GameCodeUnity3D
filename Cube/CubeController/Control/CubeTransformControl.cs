...
class CubeTransformControl
{
    public CubeTransformControl(MBCubeObject pCubeController)
    {
    ...
    public CubeTransformControl(MBCubeObject pCubeController, float pDeltaTime = -1)
    {
        Transform = pCubeController.Transform.Transform;
        Position = pCubeController.Transform.Position;
    ...
    public CubeTransformControl(MBCubeObject pCubeController, Vector3 pNextPosition)
    {
        Transform = pCubeController.Transform.Transform;
        Position = pCubeController.Transform.Position;
